...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference("Cliente.count") do
      post clientes_url, params: { cliente: { dataNascimento: @cliente.dataNascimento, nome: @cliente.nome } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { dataNascimento: @cliente.dataNascimento, nome: @cliente.nome } }
